...
<?php $__env->startSection('title', 'HP Store - Toko Smartphone Terpercaya'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center gap-10">
        <div class="flex-1">
            ...
            <div class="mt-8 flex flex-wrap gap-4">
                <a href="<?php echo e(route('products.index')); ?>" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold px-8 py-3 rounded-xl transition">
                    <i class="fas fa-shopping-bag mr-2"></i> Belanja Sekarang
                </a>
                <a href="<?php echo e(route('products.index', ['sort' => 'price_asc'])); ?>" class="border border-white text-white hover:bg-white hover:text-gray-900 font-semibold px-8 py-3 rounded-xl transition">
...
<section class="max-w-7xl mx-auto px-4 py-12">
    ...
    <div class="grid grid-cols-3 md:grid-cols-6 gap-4">
        ...
        <a href="<?php echo e(route('products.index', ['category' => $cat->slug])); ?>"
           class="bg-white rounded-2xl p-4 text-center shadow-sm hover:shadow-md card-hover border border-gray-100">
            <div class="text-4xl mb-2"><?php echo e($cat->icon); ?></div>
            <div class="text-sm font-semibold text-gray-700"><?php echo e($cat->name); ?></div>
            <div class="text-xs text-gray-400 mt-1"><?php echo e($cat->products_count); ?> produk</div>
        </a>
...
<section class="max-w-7xl mx-auto px-4 py-8">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(route('products.index')); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
...
<section class="max-w-7xl mx-auto px-4 py-8">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(route('products.index', ['sort' => 'newest'])); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
            Lihat Semua <i class="fas fa-arrow-right ml-1"></i>
        </a>
    </div>
    <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
...
<section class="max-w-7xl mx-auto px-4 py-8">
    <div class="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 text-white flex flex-col md:flex-row items-center justify-between">
        ...
        <a href="<?php echo e(route('register')); ?>" class="mt-4 md:mt-0 bg-white text-purple-700 font-bold px-8 py-3 rounded-xl hover:bg-purple-50 transition">
            Daftar Gratis
        </a>
    </div>
</section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\benerd\LaravelProject\hp-store\resources\views/home.blade.php ENDPATH**/ ?>